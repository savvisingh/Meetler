...
public class friends_fragment extends Fragment {
    ViewPager mpager;
    friends_fragment_pager_adapter TabAdapter;
    SlidingTabLayout mtabs;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View friends = inflater.inflate(R.layout.activity_meetler__home_, container, false);

        TabAdapter= new friends_fragment_pager_adapter(getFragmentManager());
        mpager = (ViewPager)friends.findViewById(R.id.pager);
        mtabs=(SlidingTabLayout) friends.findViewById(R.id.tabs);
